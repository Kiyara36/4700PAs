...
epi{1}(10:70,70:95)= c_eps_0*11.3; 
epi{1}(40:105,90:100)= c_eps_0*11.3; 
epi{1}(70:120,50:120)= c_eps_0*11.3; 

% There is no reflection, it just transmissions
% 11.3 value - the resistivity of the grating, how much light is allowed to pass
% through
...
mag = 10; %potentially controlling field density..?
phi = 0;
omega = f*2*pi;
betap = 0;
t0 = 30e-15;
st = -0.05;  %Speed of the grating
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;

bc{1}.NumS = 1;
bc{1}.s(1).xpos = 33; %nx{1}/(4) + 1;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
bc{1}.s(1).paras = {mag,phi,omega,betap,t0,st,s,y0,sty,'s'};

bc{1}.NumS = 2;
bc{1}.s(2).xpos = 33; %nx{1}/(4) + 1;
bc{1}.s(2).type = 'ss';
bc{1}.s(2).fct = @PlaneWaveBC;
bc{1}.s(2).paras = {mag,phi,omega,betap,t0,st,s,yMax,sty,'s'};
